...
if __name__ == "__main__":
    css = return_css(encode_image(r'C:\Users\chsjk\PycharmProjects\Future_Ocean\result\20250102-170713\0.png'))
    with gr.Blocks(css=css) as demo:
        button = Button_foregrund_image(
            img_file_path=r'C:\Users\chsjk\PycharmProjects\Future_Ocean\result\20250102-170713\0.png')
        button.click(
