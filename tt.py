...
class GradioInterface:
    ...
    def generate_merged_video(self, cur_file_paths, *method_inputs):
        """
        :param cur_file_paths: list of file_paths used for video_merge
        :param method_inputs:
        :return:
        """
                        ...
                        with gr.Tab("Merge"):
                            with gr.Column():
                                ...
                                video_button.click(
                                    ...
                                    inputs=[cur_filepaths] + method_inputs,
                                    outputs=None
                                )
        return demo
